...
const translations = {
    mr: {
        ...
        'lbl_districts_in_division': 'विभागातील जिल्हे:',
        'lbl_division_filter': 'विभाग:',
        'btn_back': 'मागे',
        'lvl_divisions': 'महसूल विभाग',
        'lvl_districts': 'जिल्हे',
        'lvl_blocks': 'तालुके / ब्लॉक्स',
        'lvl_gps': 'ग्रामपंचायती',
        'crumb_state': 'महाराष्ट्र राज्य',
        'btn_view_districts': 'जिल्हे पहा ➔',
        'btn_view_blocks': 'तालुके पहा ➔',
        'col_division': 'महसूल विभाग',
        'col_total_districts': 'एकूण जिल्हे',
        'col_total_blocks': 'एकूण तालुके',
        'col_eligible_blocks': 'पात्र तालुके',
        'col_awarded_blocks': 'पुरस्कृत तालुके',
        'col_avg_score': 'सरासरी गुण (%)',
        'col_top_block': 'अव्वल तालुका (गुण)',
    ...
    en: {
        ...
        'lbl_districts_in_division': 'Districts in Division:',
        'lbl_division_filter': 'Division:',
        'btn_back': 'Back',
        'lvl_divisions': 'Divisions',
        'lvl_districts': 'Districts',
        'lvl_blocks': 'Blocks / Talukas',
        'lvl_gps': 'Grampanchayats',
        'crumb_state': 'Maharashtra State',
        'btn_view_districts': 'View Districts ➔',
        'btn_view_blocks': 'View Blocks ➔',
        'col_division': 'Revenue Division',
        'col_total_districts': 'Districts',
        'col_total_blocks': 'Total Blocks',
        'col_eligible_blocks': 'Eligible Blocks',
        'col_awarded_blocks': 'Awarded Blocks',
        'col_avg_score': 'Avg Score (%)',
        'col_top_block': 'Top Block (Score)',
